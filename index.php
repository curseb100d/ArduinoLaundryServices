    ...
    <div class="container" id="container">
        ...
        <div class="form-container sign-up-container">
            <form class="form-signup" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                ...
                <input type="text" placeholder="First Name" name="firstname" <?php echo (!empty($firstname_err)) ? 'is-invalid' : ''; ?> value="<?php echo $firstname; ?>">
                <span class="invalid-feedback"><?php echo $firstname_err; ?></span>
                
                <input type="text" placeholder="Last Name" name="lastname" <?php echo (!empty($lastname_err)) ? 'is-invalid' : ''; ?> value="<?php echo $lastname; ?>">
                <span class="invalid-feedback"><?php echo $lastname_err; ?></span>
                
                <input type="text" placeholder="Email" name="email" <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?> value="<?php echo $email; ?>">
                <span class="invalid-feedback"><?php echo $email_err; ?></span> 
                
                <input type="password" placeholder="Password" name="password" <?php echo (!empty($password_err)) ? 'is-invalid' : ''; ?> value="<?php echo $password; ?>">
                <span class="invalid-feedback"><?php echo $password_err; ?></span>
